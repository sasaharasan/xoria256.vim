...
" Colours {{{1
"" General {{{2
hi Normal       ctermfg=15  guifg=#ffffff ctermbg=0   guibg=#000000 cterm=none gui=none
...
hi LineNr       ctermfg=239 guifg=#4e4e4e ctermbg=0   guibg=#000000
hi MatchParen   ctermfg=188 guifg=#dfdfdf ctermbg=68  guibg=#5f87df cterm=bold gui=bold
" TODO
" hi MoreMsg
hi NonText      ctermfg=239 guifg=#4e4e4e ctermbg=0   guibg=#000000 cterm=bold gui=bold
...
hi VertSplit    ctermfg=237 guifg=#3a3a3a ctermbg=0   guibg=#000000 cterm=none gui=none
